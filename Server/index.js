...
>>>>>>> f71a15cfbd6fc4a50082412a6adb8f060c0b0160
      ...
      const otherValue = values.find((val) => val !== randomValue);

      // Emit turn information to the randomly chosen player
      console.log("set first turn for ",randomValue);
      io.to(randomValue).emit(SOCKET.FIRST_TURN, true);
      io.to(otherValue).emit(SOCKET.FIRST_TURN, false);
