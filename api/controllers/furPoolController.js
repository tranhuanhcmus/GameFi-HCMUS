...
const getAll = async(req, res, next) => {
    try {
        const list = await models.FurPool.findAll()
...
const getById = async(req, res, next) => {
    try {
        ...
        const { id } = req.params
        const result = await models.FurPool.findOne({ where: { id: id } })
...
const deleteById = async(req, res, next) => {
    try {
        ...
        const { id } = req.params
        const row = await models.FurPool.findOne({ where: { id: id } })
...
const add = async(req, res, next) => {
    try {
        ...
        const newRow = await models.FurPool.create(formData)
