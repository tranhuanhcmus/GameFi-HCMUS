...
const getAll = async(req, res, next) => {
    try {
        const list = await models.EyePool.findAll()
...
const getById = async(req, res, next) => {
    try {
        ...
        const { id } = req.params
        const result = await models.EyePool.findOne({ where: { id: id } })
...
const deleteById = async(req, res, next) => {
    try {
        ...
        const { id } = req.params
        const row = await models.EyePool.findOne({ where: { id: id } })
...
const add = async(req, res, next) => {
    try {
        ...
        const newRow = await models.EyePool.create(formData)
